      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-14">
          {benefits.map((b) => (
            <div
              key={b.title}
              className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-7 transition-all duration-300 hover:-translate-y-1 hover:border-white/20 hover:shadow-xl"
            >
              <div className="absolute top-0 right-0 h-32 w-32 -mr-8 -mt-8 rounded-full bg-white/[0.03] blur-2xl pointer-events-none" />
        ...
        <div className="text-center">
          <a
            ...
            className="inline-flex items-center gap-3 rounded-full px-9 py-4 transition-all duration-200 group font-heading font-semibold text-[0.95rem] text-zinc-100 border border-white/10 bg-white/5 backdrop-blur-xl hover:bg-white/10 hover:border-white/20"
          >
