          ...
          <div>
            <div className="animated-border">
              <div
                ...
                style={{ background: "#18181B", aspectRatio: "16/9", position: "relative" }}
              >
                {/* Faint chart */}
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-4">
                  <div
                    className="w-16 h-16 rounded-full bg-amber-500 flex items-center justify-center group-hover:scale-110 transition-transform duration-200"
                    style={{ boxShadow: "0 0 32px rgba(245,158,11,0.5)" }}
                  >
                    <svg
                      className="w-6 h-6 text-zinc-950 ml-1"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
