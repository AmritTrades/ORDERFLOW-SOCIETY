    ...
    <section className="py-32 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <a
            href="#mentorship"
            className="inline-flex items-center justify-center rounded-xl font-heading font-semibold text-base text-zinc-100 transition-all duration-200"
            style={{
              padding: "1.1rem 2.5rem",
            ...
            onMouseOver={(e) => {
              ...
              el.style.background = "rgba(39,39,42,.7)";
              el.style.borderColor = "rgba(245,158,11,.3)";
            }}
            onMouseOut={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.background = "transparent";
              el.style.borderColor = "rgba(63,63,70,.8)";
            }}
          >
