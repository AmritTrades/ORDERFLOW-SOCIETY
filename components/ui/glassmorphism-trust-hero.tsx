      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 pt-24 pb-12 sm:px-6 md:pt-32 md:pb-20 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-6 lg:mt-12">
            ...
            {/* Stats Card — updated for Orderflow Society */}
            <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl shadow-2xl">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    <div className="text-3xl font-bold tracking-tight text-white">40+</div>
                ...
                <div className="space-y-3 mb-8">
                  <div className="flex justify-between text-sm">
                    <span className="text-zinc-400">Community Growth</span>
                    <span className="text-white font-medium">Active</span>
                  </div>
                  <div className="h-2 w-full overflow-hidden rounded-full bg-zinc-800/50">
                    <div className="h-full w-[85%] rounded-full bg-gradient-to-r from-white to-zinc-400" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  <StatItem value="40+" label="Students" />
                  <div className="w-px h-full bg-white/10 mx-auto" />
                  <StatItem value="Free" label="Community" />
                  <div className="w-px h-full bg-white/10 mx-auto" />
                  <StatItem value="24/7" label="Discord" />
                </div>
