...
export function Component() {
  ...
  useEffect(() => {
    ...
    const initApplication = async () => {
      ...
      const slides = [
        { title: "The Setup", description: "Three screens. Real orderflow data. Every session starts here.", media: "https://res.cloudinary.com/dnxfphtrv/image/upload/q_100/IMG_20251210_140040_ehqgq2" },
        { title: "In the Zone", description: "Reading tape. Watching delta. This is what focus looks like.", media: "https://res.cloudinary.com/dnxfphtrv/image/upload/q_100/IMG_5387.MOV_-_VLC_media_player_24-04-2026_11_13_36_gii6zo" },
        { title: "The Work", description: "Every trade journaled. Every mistake studied. No shortcuts.", media: "https://res.cloudinary.com/dnxfphtrv/image/upload/q_100/Media_Player_24-04-2026_11_17_56_b8qpmu" },
        { title: "The Chair", description: "Hundreds of hours. Thousands of setups. This is where edge is built.", media: "https://res.cloudinary.com/dnxfphtrv/image/upload/q_100/Media_Player_24-04-2026_11_16_58_wtqcwv" },
        { title: "The Library", description: "Trading is mental. These books built the mindset behind the method.", media: "https://res.cloudinary.com/dnxfphtrv/image/upload/q_100/Media_Player_24-04-2026_11_15_49_qzq7wb" },
      ];
